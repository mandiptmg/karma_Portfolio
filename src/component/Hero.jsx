...
const Hero = () => {
  ...
  className="fixed z-50 bottom-5 right-5 animate-bounce hover:animate-none transition-all duration-300 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg"
>
  <svg
